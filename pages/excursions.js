  ...
  return (
    <MainLayout title={"Экскурсии"}>
      <main className={`lg:w-[80%] w-[90%] mx-auto mt-[6rem]`}>
        ...
        <div className={`font-p text-[15px] leading-normal text-justify my-5`}>
          <p>
            Ночное небо завораживает своей красотой в разное время года
            по-новому. Познавательная лекция под открытым небом познакомит вас с
            небесными объектами, видимыми глазом.
          </p>
          ...
          <p>
            С помощью мобильного телескопа CELESTRON c диаметром объектива 280мм
            и максимальным увеличением 660х, вы сможете рассмотреть интересные
            объекты ночного неба доступные в данное время года и ночи (луна,
            планеты, галактики, скопления звезд, туманности и др.).
          </p>
          <p>
            Профессиональный экскурсовод - сотрудник Специальной астрофизической
            обсерватории - ответит на интересующие вас вопросы и поможет
            погрузиться в увлекательный мир астрономии, где вам откроются тайны
            и загадки Вселенной.
          </p>
          <p>
            Экскурсия рассчитана на взрослых людей и школьников. Вы можете брать
            с собой детей любого возраста, в зависимости от степени их
          ...
          <p>
            ...
            облачности, осадках, тумане, высокой влажности или ветре - экскурсии
            не проводятся. Решение о проведении или отмене экскурсии принимает
            экскурсовод в день проведения, за два часа до начала.
          </p>
          <p>
            Начало экскурсии: летом примерно в 21.30, зимой около 19.00. При
            неустойчивой погоде время может корректироваться от 30 до 90 минут.
          </p>
          ...
          <p>
            Для записи на экскурсию необходимо прислать сообщение в WhatsApp или
            Telegram на номер{" "}
          ...
          <p>
            ...
            часа на улице в горах, на высоте 2070 метров. Термос с горячим чаем
            не помешает.
          </p>
        </div>
        <div className="font-p text-[21px] text-justify mb-10 lg:w-[40%] sm:w-[70%] w-[90%] mt-5 mx-auto"></div>
      </main>
    </MainLayout>
  );
}
