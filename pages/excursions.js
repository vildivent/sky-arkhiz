...
export default function Excursions() {
  return (
    <MainLayout title={"Экскурсии"} h1Title={"Дорога к звёздам"}>
      <h2
      ...
      <div className={`font-p text-[1rem] leading-normal text-justify mt-5`}>
        ...
        <p>
          С помощью мобильного телескопа CELESTRON c диаметром объектива 280мм и
          максимальным увеличением 660х, вы сможете рассмотреть интересные
        ...
        <p>
          ...
          погрузиться в увлекательный мир астрономии, где вам откроются тайны и
          загадки Вселенной.
        </p>
        <p>
          Экскурсия рассчитана на взрослых людей и школьников. Вы можете брать с
          собой детей любого возраста, в зависимости от степени их
        ...
        <p>
          Экскурсии проводятся ежедневно, но зависят от погоды, при облачности,
          осадках, тумане, высокой влажности или ветре - экскурсии не
          проводятся. Решение о проведении или отмене экскурсии принимает
        ...
        <p className={`italic`}>
          Оденьтесь и обуйтесь как следует - вам предстоит провести 1,5 - 2 часа
          на улице в горах, на высоте 2070 метров. Термос с горячим чаем не
          помешает.
        </p>
      </div>
    </MainLayout>
