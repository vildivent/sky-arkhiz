...
import type { photoGallery, photoGalleryItem } from "../constasnts";
import type { Dispatch, SetStateAction } from "react";

const GalleryCard = ({ photoGallery, imgSrc, setImgSrc }: GalleryCardProps) => {
  return (
    <>
      <div
...
type GalleryCardProps = {
  ...
  imgSrc: photoGalleryItem;
  setImgSrc: Dispatch<SetStateAction<photoGalleryItem>>;
};
